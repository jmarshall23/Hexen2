...
/*
 * $Log: /H2 Mission Pack/World.c $
 * 
 * 12    3/20/98 12:55p Jmonroe
 * made sbar arti safe, made linkedict safe, removed pent hull for NON MP
 * maps.
 * 
 * 11    3/14/98 5:13p Mgummelt
 * 
 * 10    3/13/98 4:34p Mgummelt
 * 
 * 9     3/13/98 12:02p Jmonroe
 * more fixes for hullforent
 * 
 * 8     3/13/98 5:01a Mgummelt
 * May have finally fixed that damn monster stair-stepping problem...
 * 
 * 7     3/02/98 11:04p Jmonroe
 * changed start sound back to byte, added stopsound, put in a hack fix
 * for touchtriggers area getting removed
 * 
 * 6     2/04/98 12:53a Jmonroe
 * added fastfabs
 * 
 * 5     1/08/98 4:25p Mgummelt
 * 
 * 15    10/27/97 2:51p Jheitzman
 * 
 * 14    8/26/97 8:17a Rjohnson
 * Just a few changes
 * 
 * 13    7/15/97 1:25p Rjohnson
 * Update for water moving
 * 
 * 12    7/14/97 4:47p Rjohnson
 * Fix for movetype_phase
 * 
 * 11    7/11/97 3:58p Rjohnson
 * Fix for uncrouching
 * 
 * 10    6/06/97 2:55p Rjohnson
 * Switched back to quake2 code for point contents
 * 
 * 9     6/05/97 2:46p Rjohnson
 * Some quake2 code was originally include without proper defines around
 * it
 * 
 * 8     5/20/97 11:17a Rjohnson
 * Fix? hopefully for the screwy quake2 physics
 * 
 * 7     5/05/97 5:34p Rjohnson
 * Added a quake2 console variable
 * 
 * 6     3/19/97 4:11p Rjohnson
 * Put in quake2's bmodel movement
 * 
 * 5     3/07/97 2:34p Rjohnson
 * Id Updates
 * 
 * 4     2/18/97 5:11p Rjohnson
 * Id Updates
 * 
 * 3     1/08/97 11:10a Rlove
 * Hull 4 not working
 * 
 * 2     1/08/97 10:10a Rjohnson
 * Changed the hull selection routine to use a specified hull num instead
 * of based upon size.
 */
