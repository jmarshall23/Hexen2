...
/*QUAKED Escargolon (1 0 0) (-1000 -1000 0) (1000 1000 2000) BIG GAY
Master of wickedness, naughtiness, assorted bad stuff.
...
void Escargolon ()
{
	precache_model4("models/escargolon.mdl");
	setmodel(self,"models/escargolon.mdl");
